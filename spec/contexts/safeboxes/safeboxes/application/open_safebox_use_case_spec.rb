...
RSpec.describe Safeboxes::Safeboxes::Application::OpenSafeboxUseCase, type: :use_case do
  describe "#open(input:)" do
    ...
    let(:input) { instance_double(Safeboxes::Safeboxes::Infrastructure::OpenSafeboxInput, id:, password:) }
