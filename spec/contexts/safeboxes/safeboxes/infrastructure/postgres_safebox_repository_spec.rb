  ...
  describe "#create(attributes)" do
    context "with errors" do
      it "raises an exception for a duplicated safebox" do
        ...
        safebox = Safeboxes::Safeboxes::Domain::NewSafeboxEntityFactory.create
      ...
      it "raises an exception for a password too long" do
        repository = described_class.new
        attributes = Safeboxes::Safeboxes::Domain::NewSafeboxEntityFactory.attributes(
    ...
    context "without errors" do
      it "creates a new safebox" do
        repository = described_class.new
        safebox = Safeboxes::Safeboxes::Domain::NewSafeboxEntityFactory.build
