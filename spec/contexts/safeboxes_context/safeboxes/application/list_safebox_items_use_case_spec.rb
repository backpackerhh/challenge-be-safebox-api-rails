...
RSpec.describe SafeboxesContext::Safeboxes::Application::ListSafeboxItemsUseCase, type: :use_case do
  describe "#retrieve_all(input:)" do
    ...
    context "with a locked safebox" do
      it "raises an exception" do
        input = instance_double(SafeboxesContext::Safeboxes::Infrastructure::ListSafeboxItemsInput, id:)
    ...
    context "with an invalid token" do
      it "raises an exception" do
        input = instance_double(SafeboxesContext::Safeboxes::Infrastructure::ListSafeboxItemsInput, id:, token:)
    ...
    context "with an invalid input" do
      it "returns found errors" do
        input = instance_double(
          SafeboxesContext::Safeboxes::Infrastructure::ListSafeboxItemsInput,
          invalid?: true,
          errors: ["<error>"],
          id:,
          token:
    ...
    context "when a valid input" do
      it "returns expected values" do
        ...
        safebox = SafeboxesContext::Safeboxes::Domain::SafeboxEntityFactory.build(id:)
        safebox_items = [
          SafeboxesContext::Safeboxes::Domain::SafeboxItemEntityFactory.build(safebox_id: safebox.id.value),
          SafeboxesContext::Safeboxes::Domain::SafeboxItemEntityFactory.build(safebox_id: safebox.id.value)
        ]
