...
RSpec.describe SafeboxesContext::Safeboxes::Application::CreateSafeboxUseCase, type: :use_case do
    ...
    context "with valid attributes" do
      it "creates safebox" do
        input = instance_double(
          SafeboxesContext::Safeboxes::Infrastructure::CreateSafeboxInput,
          invalid?: false,
          errors: [],
          data: attributes
        )
      ...
      it "returns safebox" do
        ...
        expect(result.safebox).to be_a(SafeboxesContext::Safeboxes::Domain::NewSafeboxEntity)
      end
    ...
    context "with invalid attributes" do
      ...
      it "does not create safebox (name too short)" do
        input = instance_double(
          ...
          invalid?: false,
          errors: [],
          data: attributes.merge(name: SafeboxesContext::Safeboxes::Domain::SafeboxNameValueObjectFactory.too_short)
        )
      ...
      it "does not create safebox (name too long)" do
        input = instance_double(
          ...
          invalid?: false,
          errors: [],
          data: attributes.merge(name: SafeboxesContext::Safeboxes::Domain::SafeboxNameValueObjectFactory.too_long)
        )
      ...
      it "does not create safebox (password bytesize too short)" do
        input = instance_double(
          ...
          data: attributes.merge(
            password: SafeboxesContext::Safeboxes::Domain::SafeboxPasswordValueObjectFactory.too_short
          )
        )
