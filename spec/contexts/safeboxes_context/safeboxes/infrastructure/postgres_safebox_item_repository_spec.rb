...
RSpec.describe SafeboxesContext::Safeboxes::Infrastructure::PostgresSafeboxItemRepository,
  ...
  describe "#all(safebox_id, params)" do
    ...
    it "returns an entity for each item associated to given safebox" do
      ...
      safebox_item_a = SafeboxesContext::Safeboxes::Domain::SafeboxItemEntityFactory.create(
        safebox_id: safebox.id.value
      )
      safebox_item_b = SafeboxesContext::Safeboxes::Domain::SafeboxItemEntityFactory.create(
        safebox_id: safebox.id.value
      )
  ...
  describe "#find_by_id(id)" do
    ...
    context "when safebox item is found" do
      it "returns the entity" do
        repository = described_class.new
        safebox = SafeboxesContext::Safeboxes::Domain::SafeboxEntityFactory.create
        safebox_item = SafeboxesContext::Safeboxes::Domain::SafeboxItemEntityFactory.create(
          safebox_id: safebox.id.value
        )
  ...
  describe "#create(attributes)" do
    context "with errors" do
      ...
      it "raises an exception for an invalid argument" do
        repository = described_class.new
        attributes = SafeboxesContext::Safeboxes::Domain::SafeboxItemEntityFactory.attributes(id: "uuid")
    ...
    context "without errors" do
      it "creates a new safebox item" do
        repository = described_class.new
        safebox = SafeboxesContext::Safeboxes::Domain::SafeboxEntityFactory.create
        safebox_item = SafeboxesContext::Safeboxes::Domain::SafeboxItemEntityFactory.build(safebox_id: safebox.id.value)
