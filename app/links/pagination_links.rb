...
class PaginationLinks
  ...
  def initialize(url_lambda:, query_params:, total_count:)
    ...
    @page_number = (query_params.dig(:page, :number) || QueryParams::PaginationValidator::DEFAULT_PAGE_NUMBER).to_i
    page_size = (query_params.dig(:page, :size) || QueryParams::PaginationValidator::DEFAULT_PAGE_SIZE).to_i
